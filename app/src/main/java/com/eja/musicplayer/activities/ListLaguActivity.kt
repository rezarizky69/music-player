package com.eja.musicplayer.activities
...
import com.eja.musicplayer.adapter.MainAdapter
import com.eja.musicplayer.model.ModelListLagu
import com.eja.musicplayer.networking.ApiEndpoint
import kotlinx.android.synthetic.main.activity_list_lagu.*
import org.json.JSONException
import org.json.JSONObject

@Suppress("DEPRECATION")
class ListLaguActivity : AppCompatActivity(), MainAdapter.onSelectData {

    var listLaguAdapter: MainAdapter? = null
    ...
    private fun getListMusic() {
        progressDialog!!.show()
        AndroidNetworking.get(ApiEndpoint.ListMusic)
    ...
    private fun showListMusic() {
        listLaguAdapter = MainAdapter(this@ListLaguActivity, modelListLagu, this)
